...
public class NetUtil {
    ...
    /**
     * 从URL上下载数据并转换为String类型
     * @param urlStr
     * @return
     */
    public synchronized String getStringFromURL(String urlStr) {
//        LogUtil.e(TAG, "urlStr" + urlStr);
//        InputStream inputStream = getInputStreamFromURL(urlStr);
//        String output = inputStream2String(inputStream);
//        LogUtil.e(TAG, "inputStream2String output" + output);
//        return output;
