...
public abstract class TaskGetMerchandiseListFromServer extends AsyncTask<Void, Void, Void> {
	private static final String TAG = "TaskGetMerchandiseListFromServer"; /*private boolean isSuccess;*/
	private String response;

	@Override
	public Void doInBackground(Void... parms) { /*String getUrl = "http://192.168.1.115:8080/user";*/
