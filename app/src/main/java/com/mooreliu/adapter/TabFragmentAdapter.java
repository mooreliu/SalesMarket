...
public class TabFragmentAdapter extends FragmentPagerAdapter { /*public class TabFragmentAdapter extends FragmentStatePagerAdapter {*/
    ...
    int[] mImageResId = {R.mipmap.main_navigation_home, R.mipmap.main_navigation_car, R.mipmap.main_navigation_catagory};
    private FragmentManager mFragmetnManager;

    public TabFragmentAdapter(FragmentManager mFragmetnManager) {
        super(mFragmetnManager);
        this.mFragmetnManager = mFragmetnManager;
    }
    ...
    public CharSequence getPageTitle(int position) {
        ...
        Drawable image = AppContext.getContext().getResources().getDrawable(mImageResId[position]);
