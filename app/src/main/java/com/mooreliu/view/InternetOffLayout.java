...
public abstract class InternetOffLayout {
    ...
    public void showInternetOffLayout() {
        if (mRootView == null) return; /* RelativeLayout parentView = (RelativeLayout)mRootView.findViewById(mParentViewId);*/
        FrameLayout parentView = (FrameLayout) mRootView.findViewById(mParentViewId);
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        InternetOffView = inflater.inflate(R.layout.view_reload, null);
